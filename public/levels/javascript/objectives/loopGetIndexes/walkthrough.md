...
코드 폴더에 `freightScanner2.js`라는 이름의 파일을 만드세요. 코드 폴더 위치는 다음과 같습니다:
...
function scan(freightItems) {
  ...
  - 만약 아이템이 "contraband"와 같다면, 현재 아이템의 인덱스 번호를 
    contrabandIndexes 배열에 추가합니다. 
    (힌트: 배열의 "push()" 메서드를 사용하세요!)
  */
...
console.log('Contraband Indexes: ' + indexes); // [1, 4] 가 출력되어야 합니다.
```
...
* [JavaScript.info - 배열 push](https://ko.javascript.info/array#methods-pop-push-shift-unshift)
