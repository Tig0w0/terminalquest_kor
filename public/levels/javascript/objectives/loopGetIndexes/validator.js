...
module.exports = async helper => {
  try {
    ...
    if (!exists) {
      helper.fail(`
        JavaScript 코드 폴더에서 "freightScanner2.js" 스크립트를 찾을 수 없습니다. 
    ...
    try {
      ...
      if (!Array.isArray(result)) {
        return helper.fail(`
          ...
          함수는 입력받은 배열에서 "contraband" 문자열과 일치하는 
          각 항목의 인덱스들이 담긴 배열을 반드시 반환해야 합니다.
        `);
      }
    ...
    helper.success(`
      ...
      <span class="highlight">두 번째 문자</span>에 대한 인덱스가 
      나타났습니다:<br/><br/>
